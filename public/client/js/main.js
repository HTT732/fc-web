...
$.extend($.easing, {
    ...
    (Riode.initPurchasedMinipopup = function () {
        setInterval(function () {
            Riode.Minipopup.open({ message: "Someone Purchased", productClass: "product-cart", name: "Daisy Shoes Sonia by Sonia-Blue", nameLink: "product.html", imageSrc: BASE_URL + "/media/cart/p1.jpg", isPurchased: !0 }, function (e) {
            ...
            (e.prototype.init = function (e) {
                ...
                (a.$wrapper = e),
                    ...
                    (function (e) {
                        ...
                        //             actionTemplate:
                        //                 '<div class="action-group d-flex mt-3"><a href="{{route("shopping-cart")}}" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">Giỏ hàng</a><a href="{{route("checkout")}}}" class="btn btn-sm btn-primary btn-rounded">Mua ngay</a></div>',
                        //         });
                        // });
                    })(this);
            }),

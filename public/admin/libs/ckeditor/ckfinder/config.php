...
$config['licenseName'] = 'trung.com';
$config['licenseKey']  = '*5?7-*1**-6**C-*6**-*4**-S*C*-2**J';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'https://web-fc.herokuapp.com/uploads/products/content', //Thư mục chứa file upload

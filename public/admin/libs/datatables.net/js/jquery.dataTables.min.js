...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Trước",sLast:"Cuối",sNext:"Tiếp",sPrevious:"Trước"},sEmptyTable:"Không tìm thấy kết quả",sInfo:"Hiển thị _START_ - _END_ trên _TOTAL_ kết quả",sInfoEmpty:"Không có kết quả",sInfoFiltered:"(Tìm kiếm trên _MAX_ kết quả)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ kết quả",sLoadingRecords:"Đang tải...",sProcessing:"Đang xử lý...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy kết quả"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(l.defaults);l.defaults.column={aDataSort:null,

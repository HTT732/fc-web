                ...
                <div class="order-message mr-auto ml-auto">
                    <div class="icon-box d-inline-flex align-items-center">
                        ...
                        <div class="icon-box-content text-left">
                            <h5 class="icon-box-title font-weight-bold lh-1 mb-1">Cảm Ơn Quý Khách!</h5>
                            <p class="lh-1 ls-m">Đơn hàng đã được tiếp nhận</p>
                        </div>
                    </div>
                </div>
                <div class="text-center mt-4">
                    <a href="{{route('home')}}" class="mt-4 btn btn-icon-left btn-dark btn-back btn-rounded btn-md mb-4"><i class="d-icon-arrow-left"></i>Trở Lại Trang Chủ</a>
                </div>

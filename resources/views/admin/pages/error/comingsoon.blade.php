                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-5">
                            <a href="index.html" class="logo"><img src="assets/images/logo-dark.png" height="24" alt="logo"></a>
                            <h5 class="font-size-16 mb-4">Responsive Bootstrap 4 Admin Dashboard</h5>
